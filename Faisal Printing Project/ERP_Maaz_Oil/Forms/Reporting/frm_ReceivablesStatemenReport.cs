...
{
    public partial class frm_ReceivablesStatemenReport : Form
    {
        Classes.Helper classHelper = new Classes.Helper();
        public frm_ReceivablesStatemenReport()
        {
            InitializeComponent();
        }
        ...
        private void ShowReport()
        {
            ...
            CASE WHEN A.DR_CR = 'D' THEN (A.OPEN_BAL+ISNULL(C.BALANCE,0)) ELSE (-A.OPEN_BAL+ISNULL(C.BALANCE,0)) END AS [OPENING]
            FROM COA A
            LEFT JOIN
            ...
            WHERE A.STAT = '0' AND A.CA_ID IN ('1','4','21')";
            ...
            try
            {
                ...
                if (classHelper.dr.HasRows == true)
                {
                    ...
                    while (classHelper.dr.Read())
                    {
                        ...
                        classHelper.dataR["title"] = "RECEIVABLES SUMMARY";
