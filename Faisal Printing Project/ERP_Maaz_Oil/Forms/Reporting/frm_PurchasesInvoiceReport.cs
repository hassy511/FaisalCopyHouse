...
namespace ERP_Maaz_Oil.Forms.Reporting
{
    public partial class frm_PurchasesInvoiceReport : Form
    {
        ...
        private void ShowReport()
        {
            ...
            A.INVOICE_NO AS [BILL NO.],A.VEHICLE_NO AS [VEHICLE NUMBER],
            D.COA_NAME AS [SUPPLIER NAME],C.MATERIAL_NAME AS [ITEM],
            ...
            WHERE D.STAT = '0' AND A.DATE BETWEEN '" + Classes.Helper.ConvertDatetime(dtp_FROM.Value.Date) + @"' 
