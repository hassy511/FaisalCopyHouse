...
namespace ERP_Maaz_Oil.Forms.Reporting
{
    public partial class frmReports : Form
    {
        ...
        public void GenerateReport(string reportName, System.Data.DataSet ds)
        {
            ...
            else if (reportName == "ProductionReport") {
                Reports.ProductionReport rpt = new Reports.ProductionReport();
                rpt.SetDataSource(ds.Tables["ProductionReport"]);
                rpt.Subreports[0].SetDataSource(ds.Tables["ProductionSummary"]);
            ...
            else if (reportName == "PR")
            {
                Reports.rptPR rptPI = new Reports.rptPR();
