...
namespace ERP_Maaz_Oil.Forms
{
    public partial class frmDashboard : Form
    {
        ...
        {
            frmPurchasesOrderMaterial frmpo = new frmPurchasesOrderMaterial();
            frmpo.Show();
        }
        ...
        {
            Forms.frmSales_New frm = new Forms.frmSales_New();
            frm.ShowDialog();
        }
        ...
        {
            frmPurchases_Return frmpr = new frmPurchases_Return();
            frmpr.Show();
        }

        private void productionReportToolStripMenuItem1_Click(object sender, EventArgs e)
        {
            ERP_Maaz_Oil.Forms.Job.frmProductionReport frm = new ERP_Maaz_Oil.Forms.Job.frmProductionReport();
            frm.ShowDialog();
        }

        private void searchMaterialTaggingToolStripMenuItem_Click(object sender, EventArgs e)
        {
            frmSearchMaterialListing frm = new frmSearchMaterialListing();
            frm.ShowDialog();
        }

        private void searchProductTaggingToolStripMenuItem_Click(object sender, EventArgs e)
        {
            frmSearchProductListing frm = new frmSearchProductListing();
            frm.ShowDialog();
        }
    }
}
