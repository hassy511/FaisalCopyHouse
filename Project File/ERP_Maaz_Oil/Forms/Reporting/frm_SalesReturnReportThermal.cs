...
{
    public partial class frm_SalesReturnReportThermal : Form
    {
        Classes.Helper classHelper = new Classes.Helper();
        public frm_SalesReturnReportThermal()
        {
            InitializeComponent();
        }
        ...
        private void ShowReport()
        {
            ...
            if (hasRows == 'Y')
            {
                ...
                classHelper.rpt.GenerateReport("SalesReturnReportThermal", classHelper.mds);
