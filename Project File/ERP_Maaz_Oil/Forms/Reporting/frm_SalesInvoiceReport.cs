...
namespace ERP_Maaz_Oil.Forms.Reporting
{
    public partial class frm_SalesInvoiceReport : Form
    {
        ...
        /*private void ShowReport()
           {
               ...
               if (chkProduct.Checked == false) {
                   ...
                   INNER JOIN COA D ON A.CUSTOMER_ID = D.COA_ID
                   WHERE D.STAT = '0' AND [DATE] BETWEEN '" + dtp_FROM.Value.Date + "' AND '" + dtp_TO.Value.Date.AddHours(23).AddMinutes(59).AddSeconds(59) + @"'";
               }
        ...
        private void showReport()
        {
            ...
            {
                classHelper.query += " AND D.COA_ID = '" + cmbCustomer.SelectedValue.ToString() + "'";
            }
            if (cmbReference.SelectedIndex > 0)
            {
                classHelper.query += " AND A.REFERENCE = '" + cmbReference.Text + "'";
            }
            if (cmbProduct.SelectedIndex > 0)
            {
                classHelper.query += " AND C.PM_ID = '" + cmbProduct.SelectedValue.ToString() + "'";
            }
