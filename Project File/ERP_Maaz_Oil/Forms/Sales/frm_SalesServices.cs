...
{
    public partial class frm_SalesServices : Form
    {
        Classes.Helper classHelper = new Classes.Helper();
        int id = 0;
        bool isEdit = false;
        public frm_SalesServices()
        {
            InitializeComponent();
        }
        ...
        private void GenerateSINumber()
        {
            ...
            lblInvoice.Text = "PSI-" + classHelper.GetMaxValue(classHelper.query) + "-" + DateTime.Now.Year;
        }
        ...
        private void LoadGrid()
        {
            ...
            A.CREDIT_DAYS,A.CUSTOMER_ID,TERM,SO_ID,A.BILL_NO,A.IS_POSTED,A.REFERENCE
            FROM SALE_MASTER A
            INNER JOIN COA B ON A.CUSTOMER_ID = B.COA_ID
            WHERE A.SALE_MASTER_ID IN (SELECT SALE_MASTER_ID FROM SALE_EXPENSE)
        ...
        {
            classHelper.LoadSuppliers(cmbVendor);
        }
        ...
        {
            classHelper.LoadServices(cmbServices);
        }
        ...
        {
            {
                ...
                else if (grdExpenses.Rows.Count <= 0)
                {
                    classHelper.ShowMessageBox("Add Expense.", "Warning");
                    cmbVendor.Focus();
                }
                else
                {
                ...
                classHelper.query += @" DELETE FROM SALE_DETAIL WHERE SALE_MASTER_ID = '" + id + @"'";
                    ...
                    foreach (DataGridViewRow rows in gridProducts.Rows)
                    {
                      ...
                      + rows.Cells["gstValue"].Value.ToString() + @"','0');";
                    }

                    classHelper.query += @" DELETE FROM SALE_EXPENSE WHERE SALE_MASTER_ID = '" + id + @"'";
                    classHelper.query += @" DELETE FROM LEDGERS WHERE REF_ID = " + id + @" AND ENTRY_OF = 'SERVICE'";

                    foreach (DataGridViewRow rows in grdExpenses.Rows)
                    {
                        classHelper.query += @" INSERT INTO SALE_EXPENSE (SALE_MASTER_ID,[DATE],VENDOR_ID,SERVICE_ID,[DESCRIPTION],[TYPE],AMOUNT,CREATION_DATE,CREATED_BY) 
                            VALUES (" + masterId + ",'" + rows.Cells["date"].Value.ToString() + "','"
                        + rows.Cells["vendorId"].Value.ToString() + @"','" + rows.Cells["serviceId"].Value.ToString() + @"','"
                      + rows.Cells["description"].Value.ToString() + @"','" + rows.Cells["type"].Value.ToString() + @"','" + rows.Cells["expenseAmount"].Value.ToString() + @"',getdate(),'" + Classes.Helper.userId + @"');";
                        ...
                        if (chkPosted.Checked == true)
                        {
                            ...
                            VALUES('" + rows.Cells["date"].Value.ToString() + "','" + Classes.Helper.printingExpense +
                                            "'," + masterId + ",'SERVICE','" + lblInvoice.Text + @"', '" + rows.Cells["expenseAmount"].Value.ToString() + "',0,'S.I # " + classHelper.AvoidInjection(cmbReference.Text) + @" / " + rows.Cells["description"].Value.ToString() + ")','" + Classes.Helper.userId + @"',GETDATE(),1);

                            INSERT INTO LEDGERS(DATE, COA_ID, REF_ID, ENTRY_OF, FOLIO, DEBIT, CREDIT, DESCRIPTIONS, CREATED_BY, CREATION_DATE, COMPANY_ID)
                            VALUES('" + rows.Cells["date"].Value.ToString() + "','" + rows.Cells["vendorId"].Value.ToString() +
                                            "'," + masterId + ",'SERVICE','" + lblInvoice.Text + @"',0, '" + rows.Cells["expenseAmount"].Value.ToString() + "','S.I # " + classHelper.AvoidInjection(cmbReference.Text) + @" / " + rows.Cells["description"].Value.ToString() + ")','" + Classes.Helper.userId + @"',GETDATE(),1);";

                            if (rows.Cells["type"].Value.ToString().Equals("0"))
                            {
                            ...
                            INSERT INTO LEDGERS(DATE, COA_ID, REF_ID, ENTRY_OF, FOLIO, DEBIT, CREDIT, DESCRIPTIONS, CREATED_BY, CREATION_DATE, COMPANY_ID)
                            VALUES('" + rows.Cells["date"].Value.ToString() + "','" + Classes.Helper.cashId +
                                            "'," + masterId + ",'SERVICE','" + lblInvoice.Text + @"',0, '" + rows.Cells["expenseAmount"].Value.ToString() + "','S.I # " + classHelper.AvoidInjection(cmbReference.Text) + @" / " + rows.Cells["description"].Value.ToString() + ")','" + Classes.Helper.userId + @"',GETDATE(),1);";
                            }
                        }
                    ...
                    if (chkPosted.Checked == true) {
                        classHelper.query += @" 
                            ...
                            VALUES('" + dtpDate.Value.ToString() + "','" + Classes.Helper.salesId +
                                        "'," + masterId + ",'SALES','" + lblInvoice.Text + @"', 0,'" + txtNetTotal.Text + "','S.I # " + classHelper.AvoidInjection(cmbReference.Text) + @" / " + txtBillNo.Text + " /" + txtCreditDays.Text + " DAYS PAYMENT)','" + Classes.Helper.userId + @"',GETDATE(),1);

                            INSERT INTO LEDGERS(DATE, COA_ID, REF_ID, ENTRY_OF, FOLIO, DEBIT, CREDIT, DESCRIPTIONS, CREATED_BY, CREATION_DATE, COMPANY_ID)
                            VALUES('" + dtpDate.Value.ToString() + "','" + cmbCustomer.SelectedValue.ToString() + "'," + masterId + ",'SALES','" + lblInvoice.Text + @"',
                            '" + txtNetTotal.Text + "',0,'S.I # " + classHelper.AvoidInjection(cmbReference.Text) + @" / " + txtBillNo.Text + " /" + txtCreditDays.Text + " DAYS PAYMENT)','" + Classes.Helper.userId + @"',GETDATE(),1);

                            INSERT INTO LEDGERS(DATE, COA_ID, REF_ID, ENTRY_OF, FOLIO, DEBIT, CREDIT, DESCRIPTIONS, CREATED_BY, CREATION_DATE, COMPANY_ID)
                            VALUES('" + dtpDate.Value.ToString() + "','" + Classes.Helper.gstTaxId +
                            "'," + masterId + ",'SALES','" + lblInvoice.Text + @"', '" + (Convert.ToDecimal(txtNetTotal.Text) - Convert.ToDecimal(txtTotal.Text)).ToString() + "',0,'S.I # " + classHelper.AvoidInjection(cmbReference.Text) + @" / " + txtBillNo.Text + " /" + txtCreditDays.Text + " DAYS PAYMENT)','" + Classes.Helper.userId + @"',GETDATE(),1);

                            INSERT INTO LEDGERS(DATE, COA_ID, REF_ID, ENTRY_OF, FOLIO, DEBIT, CREDIT, DESCRIPTIONS, CREATED_BY, CREATION_DATE, COMPANY_ID)
                            VALUES('" + dtpDate.Value.ToString() + "','" + cmbCustomer.SelectedValue.ToString() +
                            "'," + masterId + ",'SALES','" + lblInvoice.Text + @"', 0,'" + (Convert.ToDecimal(txtNetTotal.Text) - Convert.ToDecimal(txtTotal.Text)).ToString() + "','GST on S.I # " + classHelper.AvoidInjection(cmbReference.Text) + @" / " + txtBillNo.Text + " /" + txtCreditDays.Text + " DAYS PAYMENT)','" + Classes.Helper.userId + @"',GETDATE(),1);";

                        if (rdbCash.Checked == true)
                        {
                            classHelper.query += @" INSERT INTO LEDGERS(DATE, COA_ID, REF_ID, ENTRY_OF, FOLIO, DEBIT, CREDIT, DESCRIPTIONS, CREATED_BY, CREATION_DATE, COMPANY_ID)
                            VALUES('" + dtpDate.Value.ToString() + "','" + cmbCustomer.SelectedValue.ToString() +
                                "'," + masterId + ",'SALES','" + lblInvoice.Text + @"', 0,'" + txtTotal.Text + "','S.I # " + classHelper.AvoidInjection(cmbReference.Text) + @" / " + txtBillNo.Text + " /" + txtCreditDays.Text + " DAYS PAYMENT)','" + Classes.Helper.userId + @"',GETDATE(),1);

                            INSERT INTO LEDGERS(DATE, COA_ID, REF_ID, ENTRY_OF, FOLIO, DEBIT, CREDIT, DESCRIPTIONS, CREATED_BY, CREATION_DATE, COMPANY_ID)
                            VALUES('" + dtpDate.Value.ToString() + "','" + Classes.Helper.cashId + "'," + masterId + ",'SALES','" + lblInvoice.Text + @"',
                            '" + txtTotal.Text + "',0,'S.I # " + classHelper.AvoidInjection(cmbReference.Text) + @" /  " + txtBillNo.Text + " /" + txtCreditDays.Text + " DAYS PAYMENT)','" + Classes.Helper.userId + @"',GETDATE(),1);";
                        }
                    }
        ...
        private void LoadSalesExpenses(int id)
        {
            classHelper.LoadSalesExpenses(grdExpenses, id);
        }
        ...
        private void TotalExpenseSum()
        {
            try
            {
                txtTotalExpense.Text = grdExpenses.Rows.Cast<DataGridViewRow>()
                    .Sum(t => Convert.ToDecimal(t.Cells["expenseAmount"].Value)).ToString();
            }
            catch (Exception ex)
            {
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                Convert.ToDecimal(classHelper.AvoidInjection(txtRate.Text)) - (Convert.ToDecimal(classHelper.AvoidInjection(txtRate.Text)) *
                (Convert.ToDecimal(classHelper.AvoidInjection(txtGST.Text)) / 100)),

                Convert.ToDecimal(classHelper.AvoidInjection(txtQty.Text)) * (Convert.ToDecimal(classHelper.AvoidInjection(txtRate.Text)) - (Convert.ToDecimal(classHelper.AvoidInjection(txtRate.Text)) *
                (Convert.ToDecimal(classHelper.AvoidInjection(txtGST.Text)) / 100))),
        ...
        {
            using (Forms.frmAddServiceTypes frm = new Forms.frmAddServiceTypes())
            {
        ...
        private void btnAddExpense_Click(object sender, EventArgs e)
        {
            ...
            {
                classHelper.ShowMessageBox("Vendor is not selected, please select Vendor.", "Warning");
                cmbVendor.Focus();
            }
            else if (cmbServices.SelectedIndex == 0)
            {
                classHelper.ShowMessageBox("Services is not selected, please select Services.", "Warning");
                cmbServices.Focus();
            }
            else if (txtExpenseAmount.Text.Equals("") || txtExpenseAmount.Text.Equals("0"))
            {
                classHelper.ShowMessageBox("Please add Expense Amount.", "Warning");
                txtExpenseAmount.Focus();
            }
            else
            {
                char expenseType = '0';
                if (rdbExpenseCredit.Checked == true) {
                    expenseType = '1';
                }

                grdExpenses.Rows.Add(dtpExpense.Value.Date.ToString("dd-MM-yyyy"), cmbVendor.SelectedValue.ToString(), cmbVendor.Text, cmbServices.SelectedValue.ToString(), cmbServices.Text, classHelper.AvoidInjection(txtDescription.Text),
                Convert.ToDecimal(classHelper.AvoidInjection(txtExpenseAmount.Text)), expenseType);
        ...
        private void grdExpenses_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.RowIndex >= 0)
            {
                DataGridViewRow row = this.grdExpenses.Rows[e.RowIndex];
                dtpExpense.Value = Convert.ToDateTime(row.Cells["date"].Value.ToString());
                cmbVendor.SelectedValue = row.Cells["vendorId"].Value.ToString();
                cmbServices.SelectedValue = row.Cells["serviceId"].Value.ToString();
                ...
                if (row.Cells["expenseAmount"].Value.ToString().Equals("1"))
                {
                    rdbExpenseCredit.Checked = true;
                }
                else {
                    rdbExpenseCredit.Checked = false;
                }
        ...
        private void cmbVendor_Leave(object sender, EventArgs e)
        {
            if (!classHelper.CheckAccountExists(cmbCustomer.Text))
            {
                string vendorName = cmbVendor.Text;
                DialogResult dialogResult = MessageBox.Show("Do you want to add " + cmbVendor.Text + " Account?", "Add New Account", MessageBoxButtons.YesNo);
                if (dialogResult == DialogResult.Yes)
                {
                    using (frmChartOfAccounts frm = new frmChartOfAccounts(21, 26, classHelper.AvoidInjection(cmbCustomer.Text), 0))
                    {
        ...
        private void cmbVendor_Leave_1(object sender, EventArgs e)
        {
