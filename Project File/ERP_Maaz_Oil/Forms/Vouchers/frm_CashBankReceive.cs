...
{
    public partial class CashBankReceive : Form
    {
       ...
       private void SaveCash()

        {
            ...
            double paymentAmount = double.Parse(txtAmountPay.Text);
...
AMOUNT = '" + cls_fhp.AvoidInjection(txtAmountPay.Text) + @"',
        ...
        private void txtSEARCH_TextChanged(object sender, EventArgs e)
        {
            try
            {
                cls_CPV.cvrr_grid_search(txtSEARCH, grdSEARCH);
            }
            catch (Exception ex) { MessageBox.Show(ex.Message, "Exception", MessageBoxButtons.OK, MessageBoxIcon.Information); }
          ...
          private void btnDelete_Click(object sender, EventArgs e)
            {
                ...
                if (rowIndex>=0)
                {
                    ...
                    code = grdSEARCH.Rows[rowIndex].Cells[2].Value.ToString();
