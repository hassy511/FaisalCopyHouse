...
{
    public partial class frm_CashPaymentReceive : Form
    {
        Classes.Helper classHelper = new Classes.Helper();
        int id = 0;
        bool isEdit = false;
        
        public frm_CashPaymentReceive()
        {
            InitializeComponent();
        }
        ...
        private void Save()
        {
            ...
            {
                char voucherType = 'R';
                if (rdbCashPayment.Checked == true)
                {
                    voucherType = 'P';
                }
                ...
                if (voucherType == 'R')
                {
                    ...
                    classHelper.query += @" IF EXISTS (SELECT ID FROM CASH_VOUCHER WHERE ID = '" + id + @"') 
                                     ...
                                     DELETE FROM LEDGERS WHERE REF_ID = '" + id + @"' AND ENTRY_OF = 'CASH RECEIPT';
                                      ...
                                      INSERT INTO LEDGERS VALUES('" + dtpDate.Value.ToString() + @"', '" + cmbAccounts.SelectedValue.ToString() + @"','" + masterId + "', 'CASH RECEIPT','" + lblCode.Text + @"',
                                  ...
                                  BEGIN
                                     ...
                                     INSERT INTO CASH_VOUCHER VALUES('" + voucherType + @"','" + lblCode.Text + @"',
                                      '" + dtpDate.Value.ToString() + "','" + cmbAccounts.SelectedValue.ToString() + @"',
                  ...
                  BEGIN TRANSACTION ";
                    ...
                    classHelper.query += @" IF EXISTS (SELECT ID FROM CASH_VOUCHER WHERE ID = '" + id + @"') 
                              BEGIN
                                  ...
                                  INSERT INTO LEDGERS VALUES('" + dtpDate.Value.ToString() + "','" + cmbAccounts.SelectedValue.ToString() + @"','" + masterId + "', 'CASH PAYMENT','" + lblCode.Text + @"',
                                  '" + txtAmount.Text.ToString() + "','0','" + classHelper.AvoidInjection(txtDescription.Text) + "','" + Classes.Helper.userId + @"',
                                  GETDATE(),NULL,NULL,1,NULL);                
        ...
        {
            classHelper.query = "SELECT ISNULL(MAX(ID),0)+1 FROM CASH_VOUCHER";
            lblCode.Text = "CV-" + classHelper.generate_voucher_code(classHelper.query) + "-" + DateTime.Now.Year;
        }
        ...
        private void PrintVoucher()
        {
            ...
            {   
                if (id != 0)
                {
                    ...
                    classHelper.dataR["bankName"] = cmbAccounts.Text;
